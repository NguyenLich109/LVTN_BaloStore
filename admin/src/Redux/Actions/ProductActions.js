...
// CREATE PRODUCT
export const createProduct = (name, price, description, category, discount) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`/api/products/`, { name, price, description, category, discount }, config);
